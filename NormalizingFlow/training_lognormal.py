...
#
dataset_name =  h5py.File('/anvil/scratch/x-jarmijotorre/Kappamaps/Flask/ML_datasets/logGaussianMaps_10000imgs.hdf5')
...
ts = datanorm(dataset_tensor,pmin = -0.016,pmax = 0.2)
...
weights_out = '/home/x-jarmijotorre/torchDLF_weights/NF_multiscale_normpixel_lognormalkappa_weights_'#sys.argv[2]
...
np.savetxt('/home/x-jarmijotorre/torchDLF_weights/Loss/NF_multiscale_normpix_KL_loss_lognormalkappa_weights_epochs%d_loss.dat'%epochs,loss_array)
