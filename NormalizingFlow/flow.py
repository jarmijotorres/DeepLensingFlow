...
class Dequantization(nn.Module):
    ...
    def __init__(self, alpha=1e-4, quants=256):
        """
        Inputs:
...
class VariationalDequantization(Dequantization):
    ...
    def __init__(self, var_flows, alpha=1e-4):
        """
        Inputs: 
...
class ImageFlow(pl.LightningModule):
    ...
    def __init__(self, flows, import_samples=8):
        ...
        self.prior = torch.distributions.normal.Normal(loc=0.0, scale=1)
...
def create_simple_flow():
    """
    Creates a simple flow of convolutional layers. Ideal for testing if the flow works.
    """
    flow_layers = []
    #
    for i in range(4):
...
def create_multiscale_flow(grid_size):
    flow_layers = []
